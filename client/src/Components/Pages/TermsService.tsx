  ...
  return (
    <div className="flex justify-center">
      <div className="flex flex-col justify-center items-center mt-10 py-5 border-2 w-3/4">
        <img src={terms} alt="Terms of Service" className="w-24" />
        ...
        <div className="mt-4 text-justify text-[#333] px-10">
          <p>
            ...
            <strong>STRONG MOTO CENTRUM, INC. (“SMCT”)</strong>. Throughout the
            site, the terms “we”, “us” and “our” refer to SMCT. SMCT offers this
          ...
          <p className="mt-5">SECTION 1 - ONLINE STORE TERMS</p>
          <p className="mt-5">
          ...
          <p className="mt-5">SECTION 2 - GENERAL CONDITIONS</p>
          <p className="mt-5">
          ...
          <p className="mt-5">
            ...
            our Return Policy. To view our Return Policy, please visit Return
            Policy.
          </p>
          <p className="mt-5">
          ...
          <p className="mt-5">SECTION 7 - OPTIONAL TOOLS</p>
          <p className="mt-5">
          ...
          <p className="mt-5">SECTION 8 - THIRD-PARTY LINKS</p>
          <p className="mt-5">
          ...
          <p className="mt-5">
            ...
            Please review the third-party’s policies and practices carefully and
          ...
          <p className="mt-5">SECTION 10 - PERSONAL INFORMATION</p>
          <p className="mt-5">
          ...
          <p className="mt-5">SECTION 12 - PROHIBITED USES</p>
          <p className="mt-5">
          ...
          <p className="mt-5">
            In no case shall SMCT, our directors, officers, employees,
          ...
          <p className="mt-5">SECTION 14 - INDEMNIFICATION</p>
          <p className="mt-5">
            You agree to indemnify, defend and hold harmless SMCT and our
          ...
          <p className="mt-5">SECTION 15 - SEVERABILITY</p>
          <p className="mt-5">
          ...
          <p className="mt-5">SECTION 16 - TERMINATION</p>
          <p className="mt-5">
          ...
          <p className="mt-5">SECTION 17 - ENTIRE AGREEMENT</p>
          <p className="mt-5">
          ...
          <p className="mt-5">SECTION 18 - GOVERNING LAW</p>
          <p className="mt-5">
            These Terms of Service and any separate agreements whereby we
            provide you Services shall be governed by and construed in
            accordance with the laws of the Philippines.
          </p>
          <p className="mt-5">SECTION 19 - CHANGES TO TERMS OF SERVICE</p>
          <p className="mt-5">
          ...
          <p className="mt-5">SECTION 20 - CONTACT INFORMATION</p>
          <p className="mt-5">
            Questions about the Terms of Service should be sent to us at
            dataprotectionofficer2022@gmail.com.
          </p>
          <p className="mt-5">Our contact information is posted below:</p>
          <p className="mt-5">
            <strong>STRONG MOTO CENTRUM, INC.</strong>
          </p>
          <p className="mt-5">dataprotectionofficer2022@gmail.com.</p>
          <p className="mt-5">
            Alano St., Santiago Dist., Pagadian City, Zamboanga del Sur
          </p>
          <p className="mt-5">0970-192-9564</p>
        </div>
      </div>
    </div>
  );
