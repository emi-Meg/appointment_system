...
import hondades_logo from "../../Assets/Images/hd.png";
import honda_sample from "../../Assets/Images/honda_img_sample.png";

const HondaDesFront: React.FC = () => {

  return (
    <div>
      <div className="smct-background absolute top-0 left-0 w-full h-full bg-[#F8D7DA] clip-path-custom-polygon z-[-1]"></div>
      <div className="smct-container">
        <div className="smct-logo pt-12 pl-24">
          <img src={hondades_logo} alt="Honda DES Logo" className="w-96" />
        </div>
        <div className="smct-body1 flex justify-center items-center mr-80 ml-80 mt-44">
          <div className="smct-welcome opacity-0 animate-fade-in delay-1000">
            ...
            <div className="smct-btn flex justify-center mt-10">
              <button className="text-xl font-semibold border-none bg-[#F57C6C] text-white w-72 h-14 rounded-full cursor-pointer">
                BOOK APPOINTMENT
              </button>
            </div>
          </div>
