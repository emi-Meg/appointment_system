...
import "../../Styles/GuestBooking.css";
import Lottie from "lottie-react";
import mekaniko from "../../Assets/Lottie/guest_lottie.json";
import {
  Autocomplete,
  Box,
  Button,
...
const GuestBooking: React.FC = () => {
  ...
  // State for stepper and date/time selection
    ...
    <div className="body-container">
      <div className="cover">
        <div className="cover-title">
          <h1 className="text-4xl font-bold">Book Your Service as a Guest</h1>
        </div>
        <div className="cover-lottie" style={{ width: "700px" }}>
          <Lottie
            animationData={mekaniko}
            autoPlay={true}
            loop={true}
            style={{ width: "100%" }}
          />
        </div>
        <div className="cover-FooterUser">
          <p>
            Want to modify your appointment?{" "}
            <Link to="/signup">
      ...
      <div className="guest-book">
        ...
        <form onSubmit={handleSubmitBooking}>
            ...
            <Box sx={{ width: "100%", marginTop: "30px" }}>
              ...
              {activeStep === steps.length ? (
                <React.Fragment>
                  ...
                  />
                  <Box sx={{ display: "flex", flexDirection: "row", pt: 1, pb: 2 }}>
                    <Button
                      color="inherit"
          ...
          {activeStep === steps.length - 0 && (
            <div className="guest-book-FooterUser">
              <button
                type="submit"
                className="submit-btn active:scale-95 transition-all duration-150"
        ...
        <div className="final-btnup">
          <Link to="/signup">
            <strong>Register to Modify Appointment?</strong>
          </Link>
        </div>
      </div>
    </div>
