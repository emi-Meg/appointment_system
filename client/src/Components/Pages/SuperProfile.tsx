        ...
        {data.map((info, index) => (
          <div className="flex flex-col items-center w-full md:w-3/4 lg:w-1/4 mt-2">
            ...
            <div className="flex flex-row items-center mt-2 w-full justify-center space-x-2">
              <button className="py-2 bg-slate-700 hover:bg-slate-800 transition duration-300 text-white rounded-lg w-full active:scale-95">
                Cancel
              </button>
              <button className="py-2 bg-green-700 hover:bg-green-800 transition duration-300 text-white rounded-lg w-full active:scale-95">
                Save
              </button>
            </div>
          </div>
