...
import suzuki_ozamiz from "../../Assets/Images/suzuki_auto_ozamiz.png";
import suzukioz_sample from "../../Assets/Images/suzukiozamiz_img_sample.png";

const SuzukiOzamizFront: React.FC = () => {
    ...
    <div>
      ...
      <div className="smct-container">
        <div className="smct-logo pt-12 pl-24">
          <img src={suzuki_ozamiz} alt="Suzuki Ozamiz Logo" className="w-96" />
        </div>
...
export default SuzukiOzamizFront;
