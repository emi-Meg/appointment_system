...
import dsm_logo from "../../Assets/Images/dsm.png";
import destrong_sample from "../../Assets/Images/desstrong_img_sample.png";

const DesStrongFront: React.FC = () => {
    ...
    <div>
      ...
      <div className="smct-container">
        <div className="smct-logo pt-12 pl-24">
          <img src={dsm_logo} alt="SMCT, Inc. Logo" className="w-96" />
        </div>
        <div className="smct-body1 flex justify-center items-center mr-80 ml-80 mt-44">
          <div className="smct-welcome opacity-0 animate-fade-in delay-1000">
            ...
            <div className="smct-btn flex justify-center mt-10">
              <button className="text-xl font-semibold border-none bg-[#D4AF37] text-white w-72 h-14 rounded-full cursor-pointer">
                BOOK APPOINTMENT
              </button>
            </div>
          </div>
