        ...
        <Grid2 container spacing={2}>
          ...
          <Grid2 size={{lg:8, sm:10, xs:10}}>
            <div className="flex flex-col mt-40">
              ...
              <BookOnlineIcon/>
              <h2 className="text-2xl font-bold ml-2">MANAGE YOUR BOOKINGS</h2>
              </div>
              ...
              <div className="mt-2">
                      ...
                      {(rowsPerPage > 0
                        ...
                        <TableRow key={booking.id}>
                          ...
                          <Link to={`/user/viewbooking/${booking.id}`}>
                            ...
                            <button className="bg-[#DC3545] text-white px-2 py-1 rounded-3xl" onClick={() => handleClickOpen(booking.id)}>
                              Cancel
                            </button>
                          </TableCell>
                        </TableRow>
                ...
                <CancelBookingModal open={open} onClose={handleClose} bookingId={selectedId} />
              </div>
            </div>
          </Grid2>
          <Grid2 size={{lg:2, sm:1, xs:1 }} />
